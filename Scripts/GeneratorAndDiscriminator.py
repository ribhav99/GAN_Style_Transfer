...
class Discriminator(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(args.image_dimensions[2], args.features_d, args.kernel_size, stride=2, padding = 1),nn.BatchNorm2d(args.features_d) ,nn.ReLU(), nn.MaxPool2d(args.max_pool))
        self.conv2 = nn.Sequential(nn.Conv2d(args.features_d, args.features_d * 2, args.kernel_size, stride=2, padding = 1),nn.BatchNorm2d(args.features_d * 2) ,nn.ReLU(), nn.MaxPool2d(args.max_pool))
        self.conv3 = nn.Sequential(nn.Conv2d(args.features_d * 2, args.features_d * 4, args.kernel_size, stride=2, padding = 1),nn.BatchNorm2d(args.features_d * 4) ,nn.ReLU(), nn.MaxPool2d(args.max_pool))
        ...
        self.linear1 = nn.Sequential(nn.Linear(self._linear_dim, 150), nn.BatchNorm1d(150), nn.ReLU())
...
class Generator(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.conv1 = nn.Conv2d(args.cartoon_dimensions[2], args.features_g, args.kernel_size, padding =1), nn.BatchNorm2d(args.features_g), nn.ReLU(), nn.MaxPool2d(args.max_pool)
        self.conv2 = nn.Conv2d(args.features_g, args.features_g * 2, args.kernel_size, padding =1), nn.BatchNorm2d(args.features_g * 2), nn.ReLU(), nn.MaxPool2d(args.max_pool)
        self.conv3 = nn.Conv2d(args.features_g * 2, args.features_g * 4, args.kernel_size, padding =1), nn.BatchNorm2d(args.features_g * 4), nn.ReLU(), nn.MaxPool2d(args.max_pool)
        ...
        self.trans_conv1 = nn.Sequential(nn.Upsample(scale_factor = 2), nn.ConvTranspose2d(args.features_g * 4, args.features_g * 2, args.kernel_size, padding = 1), nn.BatchNorm2d(args.features * 2), nn.ReLU())
        self.trans_conv2 = nn.Sequential(nn.Upsample(scale_factor = 2), nn.ConvTranspose2d(args.features_g * 2, args.features_g, args.kernel_size, padding = 1), nn.BatchNorm2d(args.features), nn.ReLU())
        self.trans_conv3 = nn.Sequential(nn.Upsample(scale_factor = 2), nn.ConvTranspose2d(args.features_g, args.image_dimensions[2], args.kernel_size, padding = 1), nn.Tanh())
