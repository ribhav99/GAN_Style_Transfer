...
class Discriminator(nn.Module):
    ...
    def __init__(self, features_d, kernel_size):
        ...
        fake_data = torch.rand(image_dimensions).view(-1, 1, image_dimensions[0], image_dimensions[1])
        self.conv(fake_data)
...
class Generator(nn.Module):
    ...
    def __init__(self, features_g, kernel_size):
        ...
        self.conv1 = nn.ConvTranspose2d(1, features_g, kernel_size, stride=2, padding=1)
        ...
        fake_data = torch.rand(image_dimensions).view(-1, 1, cartoon_dimensions[0], cartoon_dimensions[1])
        self.conv(fake_data)

        self.dense1 = nn.Linear(self._linear_dim, (image_dimensions[0] * image_dimensions[1])//2)
        self.dense2 = nn.Linear((image_dimensions[0] * image_dimensions[1])//2, image_dimensions[0] * image_dimensions[1])
